    ...
    <section class="tables">
        <div class="container-table">
            ...
            <div class="action-buttons">
                <a href="./add-product.html" class="btn btn-add"><i class="fa-solid fa-plus"></i>Thêm sản phẩm</a>
            ...
            <table class="table" id="productTable">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="./update-product.html" class="btn btn-edit"><i class="fas fa-edit"></i></a>
                    </td>
                </tr>
                </tbody>
            </table>

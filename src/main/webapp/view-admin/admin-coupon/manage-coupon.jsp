    ...
    <section class="tables">
        <div class="container-table">
            ...
            <div class="action-buttons">
                <a href="./add-coupon.html" class="btn btn-add"><i class="fa-solid fa-plus"></i>Thêm mã giảm giá</a>
            ...
            <table class="table" id="couponTable">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="./update-coupon.html" class="btn btn-edit"><i class="fas fa-edit"></i></a>
                    </td>
                </tr>
                <tr>
                    <td>#CP1002</td>
